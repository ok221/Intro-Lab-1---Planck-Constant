...
fit_r,cov_r = np.polyfit(rv,ri,1,w=1/errors_r,cov=True)#add w=1/errors when you have defined errors
fit_o,cov_o = np.polyfit(ov,oi,1,w=1/errors_o,cov=True)
fit_y,cov_y = np.polyfit(yv,yi,1,w=1/errors_y,cov=True)
fit_g,cov_g = np.polyfit(gv,gi,1,w=1/errors_g,cov=True)
fit_b,cov_b = np.polyfit(bv,bi,1,w=1/errors_b,cov=True)
fit_v,cov_v = np.polyfit(vv,vi,1,w=1/errors_v,cov=True)
...
plt.errorbar(rv,ri,xerr=errors_r, fmt='bo', mew=2, ms=3, capsize=4)
...
plt.errorbar(ov,oi,xerr=errors_o, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
...
plt.errorbar(yv,yi,xerr=errors_y, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
...
plt.errorbar(gv,gi,xerr=errors_r, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
...
plt.errorbar(bv,bi,xerr=errors_b, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
...
plt.errorbar(vv,vi,xerr=errors_v, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
