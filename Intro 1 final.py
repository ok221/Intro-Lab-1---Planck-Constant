...
plt.errorbar(gv,gi,xerr=errors_r,yerr=errors_ig, fmt='b.', mew=2, ms=3, capsize=2.5)
plt.xticks(np.arange(0, 4.0, 0.5))
...
plt.ylabel("Current (A)") 
plt.title("Green I-V Plot") 
plt.errorbar(gv,gi,xerr=errors_r,yerr=errors_ig, fmt='bo', mew=2, ms=3, capsize=4)
plt.xticks(np.arange(0, 4.0, 0.5))
plt.yticks(np.arange(0,0.035,0.005))
plt.plot(gv,pg(gv),color='orange')
plt.plot(0,0,'bo',ms=4)
